            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('userupdate') }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            <label for="avatar" class="col-md-4 col-form-label text-md-right">Please uplaod your image<br>
                            <span class="text-small text-info"> Previous image </span>
                            <img src="{{asset('/images/'.Auth::user()->avatar)}}" style="height:35px;width:35px; border-radius:50%; margin-right:15px;" >
                            </label>
